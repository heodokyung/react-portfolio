...
const MobileKrispyKor = () => {
  const imgData = [
    {
      src: `${require('../../../images/detailView/mobile/img_m_krispy1.jpg')}`,
      alt: '크리스피 크림 도넛 모바일 웹 스크린샷1',
    },
    {
      src: `${require('../../../images/detailView/mobile/img_m_krispy2.jpg')}`,
      alt: '크리스피 크림 도넛 모바일 웹 스크린샷2',
    },
    {
      src: `${require('../../../images/detailView/mobile/img_m_krispy3.jpg')}`,
      alt: '크리스피 크림 도넛 모바일 웹 스크린샷3',
    },
    {
      src: `${require('../../../images/detailView/mobile/img_m_krispy4.jpg')}`,
      alt: '크리스피 크림 도넛 모바일 웹 스크린샷4',
    },
    {
      src: `${require('../../../images/detailView/mobile/img_m_krispy5.jpg')}`,
...
export default MobileKrispyKor;
