...
const MobileNatuurKor = () => {
  const imgData = [
    {
      src: `${require('../../../images/detailView/mobile/img_m_natuur1.jpg')}`,
      alt: '나뚜루 팝 모바일 웹 페이지 스크린샷1',
    },
    {
      src: `${require('../../../images/detailView/mobile/img_m_natuur2.jpg')}`,
      alt: '나뚜루 팝 모바일 웹 페이지 스크린샷2',
    },
    {
      src: `${require('../../../images/detailView/mobile/img_m_natuur3.jpg')}`,
      alt: '나뚜루 팝 모바일 웹 페이지 스크린샷3',
    },
    {
      src: `${require('../../../images/detailView/mobile/img_m_natuur4.jpg')}`,
      alt: '나뚜루 팝 모바일 웹 페이지 스크린샷4',
    },
    {
      src: `${require('../../../images/detailView/mobile/img_m_natuur5.jpg')}`,
...
export default MobileNatuurKor;
