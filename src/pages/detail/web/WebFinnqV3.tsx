...
const WebFinnqV3 = () => {
  const imgData = [
    {
      src: `${require('../../../images/detailView/web/finnq_w_v2_1.jpg')}`,
      alt: 'Finnq Web Summary1',
    },
    {
      src: `${require('../../../images/detailView/web/finnq_w_v2_2.jpg')}`,
      alt: 'Finnq Web Summary2',
    },
    {
      src: `${require('../../../images/detailView/web/finnq_w_v2_3.jpg')}`,
      alt: 'Finnq Web Summary3',
    },
    {
      src: `${require('../../../images/detailView/web/finnq_w_v2_4.jpg')}`,
