...
const WebKebhana = () => {
  const imgData = [
    {
      src: `${require('../../../images/detailView/web/img_kebhana_1.jpg')}`,
      alt: 'KEB 하나은행 웹 개인뱅킹 페이지 스크린샷1',
    },
    {
      src: `${require('../../../images/detailView/web/img_kebhana_2.jpg')}`,
      alt: 'KEB 하나은행 웹 개인뱅킹 페이지 스크린샷2',
    },
    {
      src: `${require('../../../images/detailView/web/img_kebhana_3.jpg')}`,
      alt: 'KEB 하나은행 웹 개인뱅킹 페이지 스크린샷3',
    },
    {
      src: `${require('../../../images/detailView/web/img_kebhana_4.jpg')}`,
