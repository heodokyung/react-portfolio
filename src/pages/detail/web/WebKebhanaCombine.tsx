...
const WebKebhanaCombine = () => {
  const imgData = [
    {
      src: `${require('../../../images/detailView/web/img_kebhana_combine_1.jpg')}`,
      alt: '하나은행 기업뱅킹 웹 사이트 통합 개편 이미지1',
    },
    {
      src: `${require('../../../images/detailView/web/img_kebhana_combine_2.jpg')}`,
      alt: '하나은행 기업뱅킹 웹 사이트 통합 개편 이미지2',
    },
    {
      src: `${require('../../../images/detailView/web/img_kebhana_combine_3.jpg')}`,
      alt: '하나은행 기업뱅킹 웹 사이트 통합 개편 이미지3',
    },
    {
      src: `${require('../../../images/detailView/web/img_kebhana_combine_4.jpg')}`,
      alt: '하나은행 기업뱅킹 웹 사이트 통합 개편 이미지4',
    },
    {
      src: `${require('../../../images/detailView/web/img_kebhana_combine_5.jpg')}`,
