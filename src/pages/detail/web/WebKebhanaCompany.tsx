...
const WebKebhanaCompany = () => {
  const imgData = [
    {
      src: `${require('../../../images/detailView/web/img_kebhana_company_1.jpg')}`,
      alt: 'KEB 하나은행 웹 페이지 스크린샷1',
    },
    {
      src: `${require('../../../images/detailView/web/img_kebhana_company_2.jpg')}`,
      alt: 'KEB 하나은행 웹 페이지 스크린샷2',
    },
    {
      src: `${require('../../../images/detailView/web/img_kebhana_company_3.jpg')}`,
      alt: 'KEB 하나은행 웹 페이지 스크린샷3',
    },
    {
      src: `${require('../../../images/detailView/web/img_kebhana_company_4.jpg')}`,
