...
const WebKebhanaOpen = () => {
  const imgData = [
    {
      src: `${require('../../..//images/detailView/web/img_kebhana_open_1.jpg')}`,
      alt: 'KEB 하나은행 웹 페이지 스크린샷1',
    },
    {
      src: `${require('../../..//images/detailView/web/img_kebhana_open_2.jpg')}`,
      alt: 'KEB 하나은행 웹 페이지 스크린샷2',
    },
    {
      src: `${require('../../..//images/detailView/web/img_kebhana_open_3.jpg')}`,
      alt: 'KEB 하나은행 웹 페이지 스크린샷3',
    },
    {
      src: `${require('../../..//images/detailView/web/img_kebhana_open_4.jpg')}`,
