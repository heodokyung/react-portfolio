...
const WebLottemembers = () => {
  const imgData = [
    {
      src: `${require('../../../images/detailView/web/img_w_lotte1.jpg')}`,
      alt: '롯데멤버스 메인 페이지 스크린샷1',
    },
    {
      src: `${require('../../../images/detailView/web/img_w_lotte2.jpg')}`,
      alt: '롯데멤버스 메인 페이지 스크린샷2',
    },
    {
      src: `${require('../../../images/detailView/web/img_w_lotte3.jpg')}`,
