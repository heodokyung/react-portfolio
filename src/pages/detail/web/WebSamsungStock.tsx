...
const WebSamsungStock = () => {
  const imgData = [
    {
      src: `${require('../../../images/detailView/web/img_w_stock1.jpg')}`,
      alt: '삼성증권, 삼성뱅킹 웹 페이지 스크린샷1',
    },
    {
      src: `${require('../../../images/detailView/web/img_w_stock2.jpg')}`,
      alt: '삼성증권, 삼성뱅킹 웹 페이지 스크린샷2',
    },
    {
      src: `${require('../../../images/detailView/web/img_w_stock3.jpg')}`,
